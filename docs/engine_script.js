...
Copyright (C) 2017-2020 by Fabien Fellay
...
function Start(load_event) { // The load_event can be used in case of need
    ...
    // Display: get the hands object from the parent svg (can be done only after load)
    ...
    // Display: get the hands shade object from the parent svg (can be done only after load)
...
function SimStep(sim) {
    ...
    // Hands shades are automatically animated by the <use> tags in the parent svg
}
